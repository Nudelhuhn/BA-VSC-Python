...
\input{chapters/VorgehensweiseImplementierung}
\input{chapters/Forschungsergebnisse}
...
%------------------ Anhänge ----------------------------------------------------
\begin{appendix}
	\include{chapters/Eigenstaendigkeitserklaerung}		% Eigenständigkeitserklärung
\end{appendix}
